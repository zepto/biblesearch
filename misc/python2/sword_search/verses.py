...
class Verse(object):
    ...
    def __init__(self, reference="Genesis 1:1"):
    ...
    def _get_valid(self, reference, default="Genesis 1:1"):
    ...
    def _abs_chapter(self, book_index, chapter):
    ...
    def _abs_verse(self, book_index, chapter, verse):
    ...
    def _get_verse_offset(self, book, chapter, verse):
...
class VerseRange(object):
    ...
    def __init__(self, start="Genesis 1:1", end="Revelation 22:21"):
...
def parse_verse_range(verse_list):
...
def sort_key(ref):
    ...
    try:
        ...
        print('Error sorting "%s": %s' % (ref, err))
        sys.exit()
